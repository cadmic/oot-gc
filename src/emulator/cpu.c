...
inline s32 cpuFindBranchOffset(CpuFunction* pFunction, s32* pnOffset, s32 nAddress, s32* anCode) {
    s32 iJump;
...
#else
// TODO: move these inline functions around in the file
inline bool cpuCutStoreLoad(Cpu* pCPU, s32 currentAddress, s32 source) {
...
inline bool cpuCutStoreLoadF(Cpu* pCPU, s32 currentAddress, s32 source) {
    if (pCPU->nOptimize.validCheck == 0) {
        return 0;
    }
...
static bool cpuCutStoreLoadAddr(Cpu* pCPU, s32 currentAddress, s32 source, s32 target, s32* anCode) {
    if (anCode == NULL) {
        return 0;
    }
    if (pCPU->nOptimize.validCheck == 0) {
...
static bool cpuGetPPC(Cpu* pCPU, s32* pnAddress, CpuFunction* pFunction, s32* anCode, s32* piCode, bool bSlot) {
    ...
    if (!ramGetBuffer(SYSTEM_RAM(pCPU->pHost), &pnOpcode, *pnAddress, 0)) {
        return 0;
    }
    ...
    *pnAddress = nAddress + 4;
    ...
    if (iCode == 0) {
        ...
        if (!bInterpret && cpuCheckDelaySlot(nOpcode) == 0) {
            // TODO: clean
            if ((s32)(((s32)(pFunction->nAddress1 - pFunction->nAddress0) >> 2) + 1) > 0x19) {
                bInterpret = 1;
            } else {
                update = 1;
            }
    ...
    if (!bInterpret) {
        ...
        switch (MIPS_OP(nOpcode)) {
            case 0x00: // special
                switch (MIPS_FUNCT(nOpcode)) {
                        ...
                        if (nOpcode != 0) {
                            ...
                            if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                                ...
                                if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RT(nOpcode))) {
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x7C060000 | (pCPU->nOptimize.destGPR_mapping << 21) |
                                                          (pCPU->nOptimize.destGPR_mapping << 11) | 0x378;
                                    } else {
                                        iCode += 1;
                                    }
                                } else {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x54000000 | (iRegisterB << 21) | (iRegisterA << 16) |
                                                  (MIPS_SA(nOpcode) << 11) | ((31 - MIPS_SA(nOpcode)) << 1);
                            } else {
                                iCode += 1;
                            }
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 + (OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)].s32) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        } else {
                    ...
                    case 0x02: // srl
                        ...
                        if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                            ...
                            if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RT(nOpcode))) {
                                ...
                                if (anCode != NULL) {
                                    anCode[iCode++] =
                                        0x80C30000 + (OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)].s32) & 0xFFFF);
                                } else {
                                    iCode += 1;
                                }
                            }
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x54000000 | (iRegisterB << 21) | (iRegisterA << 16) |
                                              ((32 - MIPS_SA(nOpcode)) << 11) | (MIPS_SA(nOpcode) << 6) | 0x3E;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x03: // sra
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (MIPS_SA(nOpcode) << 11) | 0x670;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x04: // sllv
                        ...
                        if ((iRegisterC = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            ...
                            if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RS(nOpcode))) {
                                if (anCode != NULL) {
                                    anCode[iCode++] = 0x7C070000 | (pCPU->nOptimize.destGPR_mapping << 21) |
                                                      (pCPU->nOptimize.destGPR_mapping << 11) | 0x378;
                                } else {
                                    iCode += 1;
                                }
                                ...
                                if (anCode != NULL) {
                                    anCode[iCode++] =
                                        0x80E30000 + (OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)].s32) & 0xFFFF);
                                } else {
                                    iCode += 1;
                                }
                            }
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x70000000 | (iRegisterC << 21) | (iRegisterC << 16) | 0x1F;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0x30;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x06: // srlv
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0x430;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x07: // srav
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0x630;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x08: // jr
                        if (nOpcodeNext != 0) {
                            if (!cpuGetPPC(pCPU, pnAddress, pFunction, anCode, &iCode, 1)) {
                                return 0;
                            }
                            *pnAddress -= 4;
                        }
                        ...
                        if (MIPS_RS(nOpcode) == 31 && !(pCPU->nFlagCODE & 2)) {
                            if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                                ...
                                if (anCode != NULL) {
                                    anCode[iCode++] =
                                        0x80A30000 + (OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)].s32) & 0xFFFF);
                                } else {
                                    iCode += 1;
                                }
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x7C080000 | ((iRegisterA & 0x1F) << 21) | 0x3A6;
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x4E800020;
                            } else {
                                iCode += 1;
                            }
                        } else {
                            if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                                ...
                                if (anCode != NULL) {
                                    anCode[iCode++] = 0x7C050000 | (iRegisterA << 21) | (iRegisterA << 11) | 0x378;
                                } else {
                                    iCode += 1;
                                }
                            }
                    ...
                    case 0x09: // jalr
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, pFunctionLast);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CC63B78;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x3CE00000 | (((u32)nAddress + 8) >> 16);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90C50000 + OFFSETOF(pFunction, timeToLive);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x60E70000 | ((u32)nAddress & 0xFFFF);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90E30000 + OFFSETOF(pCPU, nReturnAddrLast);
                        } else {
                            iCode += 1;
                        }
                        if (ganMapGPR[31] & 0x100) {
                            // TODO: name this
                            temp_r0_17 = (u32)&anCode[iCode + 5];
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x3CA00000 + ((u32)temp_r0_17 >> 16);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x60A50000 | ((u32)temp_r0_17 & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 + (OFFSETOF(pCPU, aGPR[31]) + 4);
                            } else {
                                iCode += 1;
                            }
                        } else {
                            // TODO: name this
                            temp_r0_17 = (u32)&anCode[iCode + 4];
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x3C000000 | (ganMapGPR[31] << 21) | ((u32)temp_r0_17 >> 16);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x60000000 | (ganMapGPR[31] << 21) | (ganMapGPR[31] << 16) |
                                                  ((u32)temp_r0_17 & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        }
                        if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 + ((OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        } else {
                        ...
                        if (anCode != NULL) {
                            iCode += 1;
                            anCode[iCode++] = 0x48000000 | (((u32)pCPU->pfJump - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        // TODO: name these
                        temp_r5_21 = iCode++;
                        if (!cpuGetPPC(pCPU, pnAddress, pFunction, anCode, &iCode, 0)) {
                            return 0;
                        }
                        if (anCode != NULL) {
                            nDeltaAddress = (iCode - temp_r5_21) * 4;
                        }
                        if (anCode == NULL) {
                            break;
                        }

                        anCode[temp_r5_21] = 0x48000000 | (nDeltaAddress & 0x03FFFFFC);
                        break;
                    case 0x0C: // andi
                    case 0x0D: // ori
                    case 0x0F: // lui
                    ...
                    case 0x10: // mfhi
                        ...
                        if ((iRegisterA = ganMapGPR[MIPS_RD(nOpcode)]) & 0x100) {
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 | ((OFFSETOF(pCPU, nHi) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 | ((OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 | (OFFSETOF(pCPU, nHi) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 | (OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        } else {
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    0x80030000 | (iRegisterA << 21) | ((OFFSETOF(pCPU, nHi) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                    ...
                    case 0x11: // mthi
                        if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 | ((OFFSETOF(pCPU, nHi) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 | (OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 | (OFFSETOF(pCPU, nHi) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        } else {
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    0x90030000 | (iRegisterA << 21) | ((OFFSETOF(pCPU, nHi) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                    ...
                    case 0x12: // mflo
                        ...
                        if ((iRegisterA = ganMapGPR[MIPS_RD(nOpcode)]) & 0x100) {
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 | ((OFFSETOF(pCPU, nLo) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 | (OFFSETOF(pCPU, nLo) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    0x80030000 | (iRegisterA << 21) | ((OFFSETOF(pCPU, nLo) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                    ...
                    case 0x13: // mtlo
                        if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 | ((OFFSETOF(pCPU, nLo) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 | (OFFSETOF(pCPU, nLo) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        } else {
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    0x90030000 | (iRegisterA << 21) | ((OFFSETOF(pCPU, nLo) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                    ...
                    case 0x14: // dsllv
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80C30004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80E30004 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90C30004 + OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]);
                        } else {
                            iCode += 1;
                        }

                        if ((iRegisterC = ganMapGPR[MIPS_RD(nOpcode)]) & 0x100) {
                            break;
                        }

                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CC00000 | (iRegisterC << 16) | 0x3378;
                        } else {
                            iCode += 1;
                        }
                        break;
                    ...
                    case 0x18: // mult
                        if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            iRegisterA = 6;
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80C30000 + ((OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        }
                        if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                            iRegisterB = 7;
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80E30000 + ((OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]) + 4) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA00000 | (iRegisterA << 16) | (iRegisterB << 11) | 0x1D6;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA00000 | (iRegisterA << 16) | (iRegisterB << 11) | 0x96;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x19: // multu
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA00000 | (iRegisterA << 16) | (iRegisterB << 11) | 0x16;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x1A: // div
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA00000 | (iRegisterA << 16) | (iRegisterB << 11) | 0x3D6;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA50000 | (iRegisterB << 11) | 0x1D6;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA50000 | (iRegisterA << 11) | 0x50;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x1B: // divu
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA00000 | (iRegisterA << 16) | (iRegisterB << 11) | 0x396;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x1C: // dmult
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x9421FFC0;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91010008;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91210010;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91410018;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91610020;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91810028;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91C10030;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91E10038;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80C30004 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80E30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81030004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81C30000 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81E30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81010008;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81210010;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81410018;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81610020;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81810028;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81C10030;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81E10038;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x38210040;
                        } else {
                            iCode += 1;
                        }
                        break;
                    case 0x1D: // dmultu
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x48000000 | ((cpuCompile_DMULTU_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x1E: // ddiv
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81030000 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81230004 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81430000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81630004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x20: // add
                        ...
                        if (MIPS_RS(nOpcode) == 0) {
                            if (MIPS_RT(nOpcode) == 31 && !(pCPU->nFlagCODE & 4)) {
                                if (anCode != NULL) {
                                    anCode[iCode++] = 0x80C30000 + OFFSETOF(pCPU, nReturnAddrLast);
                                } else {
                                    iCode += 1;
                                }
                                if (anCode != NULL) {
                                    anCode[iCode++] = 0x7CC00000 | (iRegisterA << 16) | 0x3378;
                                } else {
                                    iCode += 1;
                                }
                                var_r10_2 = 1;
                                ...
                                if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0x80030000 | (iRegisterA << 21)) +
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) |
                                                          (iRegisterB << 11) | 0x378;
                                    } else {
                                        iCode += 1;
                                    }
                                ...
                                if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0x90030000 | (iRegisterA << 21)) +
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0x90030000 | (iRegisterB << 21)) +
                                                          OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                            ...
                            if ((MIPS_RS(nOpcode) == 31) && !(pCPU->nFlagCODE & 4)) {
                                ...
                                if ((iRegisterB = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (iRegisterB << 11) | ((iRegisterB << 21) | 0x7C000000 |
                                                                                0x378 | (iRegisterA << 16));
                                    } else {
                                        iCode += 1;
                                    }
                            ...
                            if (MIPS_RD(nOpcode) == 31) {
                                ...
                                if (pCPU->nFlagCODE & 8) {
                                    if ((iRegisterB = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                                        ...
                                        if (anCode != NULL) {
                                            anCode[iCode++] =
                                                0x80C30000 + (OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)].s32) & 0xFFFF);
                                        } else {
                                            iCode += 1;
                                        }
                                    }
                            ...
                            if ((iRegisterC = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                                ...
                                if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RT(nOpcode))) {
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x80E30000 + (OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)].s32) & 0xFFFF);
                                    } else {
                                        iCode += 1;
                                    }
                                }
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    0x7C000000 | (iRegisterA << 21) | (iRegisterC << 16) | (iRegisterB << 11) | 0x214;
                            } else {
                                iCode += 1;
                            }
                            var_r10_2 = 1;
                    ...
                    case 0x22: // sub
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0x50;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x24: // and
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0x38;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x25: // or
                        ...
                        if (MIPS_RS(nOpcode) == 0) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    0x7C000000 | (iRegisterA << 21) | (iRegisterC << 16) | (iRegisterB << 11) | 0x378;
                            } else {
                                iCode += 1;
                            }
                            var_r10_2 = 1;
                    ...
                    case 0x26: // xor
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0x278;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x27: // nor
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x7C000000 | (iRegisterB << 21) | (iRegisterA << 16) | (iRegisterC << 11) | 0xF8;
                        } else {
                            iCode += 1;
                        }
                    ...
                    case 0x2A: // slt
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7C000000 | (iRegisterB << 16) | (iRegisterC << 11);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x4180000C;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x38000000 | (iRegisterA << 21);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x42800008;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x38000000 | (iRegisterA << 21) | 1;
                        } else {
                            iCode += 1;
                        }
                        if (!(ganMapGPR[MIPS_RD(nOpcode)] & 0x100)) {
                    ...
                    case 0x2B: // sltu
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7C000000 | (iRegisterB << 16) | (iRegisterC << 11) | 0x40;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x2C: // dadd
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30004 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80C30000 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80E30004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81030000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90A30004 + OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90C30000 + OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x38: // dsll
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x54A50000 | (MIPS_SA(nOpcode) << 11) | ((31 - MIPS_SA(nOpcode)) << 1);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x50C50000 | (MIPS_SA(nOpcode) << 11) | ((32 - MIPS_SA(nOpcode)) << 6) | 0x3E;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x54C60000 | (MIPS_SA(nOpcode) << 11) | ((31 - MIPS_SA(nOpcode)) << 1);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                        ...
                        if ((iRegisterB = ganMapGPR[MIPS_RD(nOpcode)]) & 0x100) {
                            break;
                        }

                        if (anCode != NULL) {
                            anCode[iCode++] = (iRegisterB << 16) | 0x7CC00000 | 0x3378;
                        } else {
                            iCode += 1;
                        }
                        break;
                    case 0x3A: // dsrl
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x54C60000 | ((32 - MIPS_SA(nOpcode)) << 11) | (MIPS_SA(nOpcode) << 6) | 0x3E;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x50A60000 | ((32 - MIPS_SA(nOpcode)) << 11) | ((MIPS_SA(nOpcode) - 1) << 1);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] =
                                0x54A50000 | ((32 - MIPS_SA(nOpcode)) << 11) | (MIPS_SA(nOpcode) << 6) | 0x3E;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x3B: // dsra
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA50000 | (MIPS_SA(nOpcode) << 11) | 0x670;
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                    ...
                    case 0x3C: // dsll32
                        ...
                        while (var_r5_10 > 0) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x54A50000 | (var_r6_14 << 11) | ((31 - var_r6_14) << 1);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x50C50000 | (var_r6_14 << 11) | ((32 - var_r6_14) << 6) | 0x3E;
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x54C60000 | (var_r6_14 << 11) | ((31 - var_r6_14) << 1);
                            } else {
                                iCode += 1;
                            }
                        }
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CC00000 | (iRegisterB << 16) | 0x3378;
                        } else {
                            iCode += 1;
                        }
                        break;
                    case 0x3E: // dsrl32
                        ...
                        while (var_r5_10 > 0) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x54C60000 | ((32 - var_r6_14) << 11) | (var_r6_14 << 6) | 0x3E;
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x54C60000 | ((32 - var_r6_14) << 11) | ((var_r6_14 - 1) << 1);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x54A50000 | ((32 - var_r6_14) << 11) | (var_r6_14 << 6) | 0x3E;
                            } else {
                                iCode += 1;
                            }
                        }
                    ...
                    case 0x3F: // dsra32
                        ...
                        while (var_r5_10 > 0) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x7CA50000 | (var_r6_14 << 11) | 0x670;
                            } else {
                                iCode += 1;
                            }
                        }
            ...
            case 0x01: // regimm
                switch (MIPS_RT(nOpcode)) {
                    case 0x00: // bltz
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x2C000000 | (iRegisterA << 16);
                        } else {
                            iCode += 1;
                        }
                        ...
                        *pnAddress -= 4;
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x48000000 | (nDeltaAddress & 0x03FFFFFC);
                        } else {
                            iCode += 1;
                        }
                        if (anCode == NULL) {
                        ...
                        anCode[var_r23] = 0x40800000 | (((iCode - var_r23) & 0x3FFF) << 2);
                        break;
                    case 0x01: // bgez
                        // TODO: name
                        nAddressJump = *pnAddress + MIPS_IMM_S16(nOpcode) * 4;
                        ...
                        *pnAddress -= 4;
                        ...
                        anCode[var_r23] = 0x41800000 | (((iCode - var_r23) & 0x3FFF) << 2);
                        break;
                    case 0x02: // bltzl
                        nAddressJump = *pnAddress + MIPS_IMM_S16(nOpcode) * 4;
                        if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                    ...
                    case 0x10: // bltzal
                        ...
                        temp_r28 = iCode++;
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x3CA00000 | ((u32)(nAddress + 8) >> 16);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x60A50000 | ((u32)(nAddress + 8) & 0xFFFF);
                        } else {
                            iCode += 1;
                        }
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, nReturnAddrLast);
                        } else {
                            iCode += 1;
                        }
                        if (ganMapGPR[31] & 0x100) {
                        ...
                        *pnAddress -= 4;
                        ...
                        if (anCode != NULL) {
                            anCode[temp_r28++] = 0x40800000 | (((iCode - temp_r28) * 4) & 0xFFFC);
                        } else {
                            temp_r28 += 1;
                        }
                        ...
                        // TODO: what?
                        temp_r3_412 =
                            (u32)anCode + ((iCode * 4) + (((u32)anCode + (iCode * 4)) - ((u32)anCode + (iCode * 4))));
                        if ((iRegisterB = ganMapGPR[31]) & 0x100) {
                            if (anCode != NULL) {
                                anCode[temp_r28++] = 0x3CA00000 | ((u32)temp_r3_412 >> 16);
                            } else {
                                temp_r28 += 1;
                            }
                            if (anCode != NULL) {
                                anCode[temp_r28++] = 0x60A50000 | (temp_r3_412 & 0xFFFF);
                            } else {
                                temp_r28 += 1;
                            }
                            if (anCode == NULL) {
                            ...
                            anCode[temp_r28] = 0x90A30000 + OFFSETOF(pCPU, aGPR[31]) + 4;
                        } else {
                            if (anCode != NULL) {
                                anCode[temp_r28++] = 0x3C000000 | (iRegisterB << 21) | ((u32)temp_r3_412 >> 16);
                            } else {
                                temp_r28 += 1;
                            }
                            if (anCode == NULL) {
                            ...
                            anCode[temp_r28] =
                                0x60000000 | (iRegisterB << 21) | (iRegisterB << 16) | (temp_r3_412 & 0xFFFF);
                        }
                        break;
                    case 0x11: // bgezal
                        nAddressJump = *pnAddress + MIPS_IMM_S16(nOpcode) * 4;
                        ...
                        *pnAddress -= 4;
                        ...
                        if (anCode != NULL) {
                            anCode[temp_r28++] = 0x41800000 | (((iCode - temp_r28) * 4) & 0xFFFC);
                        } else {
                            temp_r28 += 1;
                        }
                ...
                break;
            case 0x02: // j
                nAddressJump = (*pnAddress & 0xF0000004) | (MIPS_TARGET(nOpcode) << 2);
                if (pFunction->nAddress0 <= nAddressJump && nAddressJump < pFunction->nAddress1) {
                    ...
                    *pnAddress -= 4;
                    if (nAddressJump == nAddress) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x48000000 | (((u32)pCPU->pfIdle - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                        } else {
                            iCode += 1;
                        }
                    }
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x3CA00000 | ((u32)nAddressJump >> 16);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x60A50000 | ((u32)nAddressJump & 0xFFFF);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
            ...
            case 0x03: // jal
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, nReturnAddrLast);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x60E70000 | ((u32)(nAddress + 8) & 0xFFFF);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x48000000 | (((u32)pCPU->pfCall - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                } else {
                    iCode += 1;
                }
                ...
                if (anCode != NULL) {
                    nDeltaAddress = (iCode - temp_r23_5) * 4;
                }
                if (anCode != NULL) {
                    anCode[temp_r23_5] = 0x48000000 | (nDeltaAddress & 0x03FFFFFC);
                }
                nAddressJump = -1;
                break;
            case 0x04: // beq
                ...
                if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                    ...
                    if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RS(nOpcode))) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80C30000 + (OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)].s32) & 0xFFFF);
                        } else {
                            iCode += 1;
                        }
                    }
                ...
                if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                    ...
                    if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RT(nOpcode))) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80C30000 + (OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)].s32) & 0xFFFF);
                        } else {
                            iCode += 1;
                        }
                    }
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x7C000000 | (iRegisterA << 16) | (iRegisterB << 11);
                } else {
                    iCode += 1;
                }
                temp_r23_5 = iCode++;
                ...
                *pnAddress -= 4;
                ...
                anCode[iCode++] = 0x40820000 | (((iCode - temp_r23_5) & 0x3FFF) << 2);
                break;
            case 0x05: // bne
                nAddressJump = *pnAddress + (MIPS_IMM_S16(nOpcode) * 4);
                if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                ...
                *pnAddress -= 4;
                ...
                anCode[iCode++] = 0x41820000 | (((iCode - temp_r23_5) & 0x3FFF) << 2);
                break;
            case 0x06: // blez
                nAddressJump = *pnAddress + (MIPS_IMM_S16(nOpcode) * 4);
                if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                ...
                *pnAddress -= 4;
                ...
                anCode[iCode++] = 0x41810000 | (((iCode - temp_r23_5) & 0x3FFF) << 2);
                break;
            case 0x07: // bgtz
                nAddressJump = *pnAddress + (MIPS_IMM_S16(nOpcode) * 4);
                if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                ...
                *pnAddress -= 4;
                ...
                anCode[iCode++] = 0x40810000 | (((iCode - temp_r23_5) & 0x3FFF) << 2);
                break;
            case 0x08: // addi
                ...
                if (MIPS_IMM_S16(nOpcode) == 0) {
                    if ((MIPS_RS(nOpcode) == 31) && !(pCPU->nFlagCODE & 4)) {
                        ...
                        if ((iRegisterB = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    (0x80030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]) + 4;
                            } else {
                                iCode += 1;
                            }
                        } else {
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    (iRegisterB << 11) | ((iRegisterB << 21) | 0x7C000000 | 0x378 | (iRegisterA << 16));
                            } else {
                                iCode += 1;
                            }
                        }
                        ...
                        if ((iRegisterB = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    (0x90030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, aGPR[MIPS_RD(nOpcode)]) + 4;
                            } else {
                                iCode += 1;
                            }
                            pCPU->nOptimize.destGPR_check = 2;
                    ...
                    if (MIPS_RT(nOpcode) == 31) {
                        ...
                        if (pCPU->nFlagCODE & 8) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = (0x90030000 | (iRegisterB << 21)) + OFFSETOF(pCPU, nReturnAddrLast);
                            } else {
                                iCode += 1;
                            }
                        }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38000000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    var_r10_2 = 1;
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38000000 | (iRegisterA << 21) | (iRegisterB << 16) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    var_r10_2 = 1;
                ...
                pCPU->nOptimize.destGPR_mapping = iRegisterA;
                if (anCode != NULL) {
                    anCode[iCode++] = 0x90A30000 + (OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)].s32) & 0xFFFF);
                } else {
                    iCode += 1;
                }
                break;
            ...
            case 0x0A: // slti
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x2C000000 | (iRegisterB << 16) | MIPS_IMM_U16(nOpcode);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
            ...
            case 0x0B: // sltiu
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x38E00000 | MIPS_IMM_U16(nOpcode);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x2C000000 | (iRegisterB << 16) | 0x3840;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
            ...
            case 0x0C: // andi
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x70000000 | (iRegisterB << 21) | (iRegisterA << 16) | MIPS_IMM_U16(nOpcode);
                } else {
                    iCode += 1;
                }
            ...
            case 0x0D: // ori
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x60000000 | (iRegisterB << 21) | (iRegisterA << 16) | MIPS_IMM_U16(nOpcode);
                } else {
                    iCode += 1;
                }
            ...
            case 0x0E: // xori
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x68000000 | (iRegisterB << 21) | (iRegisterA << 16) | MIPS_IMM_U16(nOpcode);
                } else {
                    iCode += 1;
                }
            ...
            case 0x0F: // lui
                ...
                if (MIPS_IMM_U16(nOpcode) >= 0x8000 && MIPS_IMM_U16(nOpcode) <= (0x8000 | (nSize >> 16))) {
                    pCPU->nFlagRAM |= (1 << MIPS_RT(nOpcode));
                } else {
                    pCPU->nFlagRAM &= ~(1 << MIPS_RT(nOpcode));
                }
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x3C000000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                } else {
                    iCode += 1;
                }
                if (!(ganMapGPR[MIPS_RT(nOpcode)] & 0x100)) {
            ...
            case 0x10: // cop0
                    ...
                    default:
                        switch (MIPS_RS(nOpcode)) {
                            ...
                            case 0x01: // dmfc0
                                ...
                                break;
                            case 0x08: // dmtc0
                                if (MIPS_RS(nOpcode) < 4 && MIPS_RS(nOpcode) >= 0) {
                                    break;
                                }
                                bFlag = 0;
                                break;
                ...
                break;
            case 0x11: // cop1
                if ((nOpcode & 0x7FF) == 0 && MIPS_FMT(nOpcode) < 0x10U) {
                    switch (MIPS_FMT(nOpcode)) {
                        case 0x00: // mfc1
                            ...
                            if (MIPS_FS(nOpcode) % 2 == 1) {
                                if (anCode != NULL) {
                                    anCode[iCode++] =
                                        (0x80030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode) - 1]);
                                } else {
                                    iCode += 1;
                                }
                            } else {
                                if (anCode != NULL) {
                                    anCode[iCode++] =
                                        (0x80030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                } else {
                                    iCode += 1;
                                }
                            }
                        ...
                        case 0x01: // dmfc1
                            pCPU->nFlagRAM &= ~(1 << MIPS_RT(nOpcode));
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80C30000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90C30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]) + 4;
                            } else {
                                iCode += 1;
                            }
                        ...
                        case 0x02: // cfc1
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    (0x80030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, anFCR[MIPS_FS(nOpcode)]);
                            } else {
                                iCode += 1;
                            }
                        ...
                        case 0x04: // mtc1
                            if ((iRegisterA = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                                if (anCode != NULL) {
                                    anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]) + 4;
                                } else {
                                    iCode += 1;
                                }
                                if (MIPS_FS(nOpcode) % 2 == 1) {
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode) - 1]);
                                    } else {
                                        iCode += 1;
                                    }
                                } else {
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                }
                                ...
                                if (MIPS_FS(nOpcode) % 2 == 1) {
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0x90030000 | (iRegisterA << 21)) +
                                                          OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode) - 1]);
                                    } else {
                                        iCode += 1;
                                    }
                                } else {
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0x90030000 | (iRegisterA << 21)) +
                                                          OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                }
                        ...
                        case 0x05: // dmtc1
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                        ...
                        case 0x06: // ctc1
                            ...
                            if (ganMapGPR[MIPS_RT(nOpcode) & 0x100]) {
                                if (anCode != NULL) {
                                    anCode[iCode++] =
                                        (0x80030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]) + 4;
                                } else {
                                    iCode += 1;
                                }
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] =
                                    (0x90030000 | (iRegisterA << 21)) + OFFSETOF(pCPU, anFCR[MIPS_FS(nOpcode)]);
                            } else {
                                iCode += 1;
                            }
                            break;
                    ...
                    switch (MIPS_FT(nOpcode)) { /* switch 14 */
                        case 0x00: // bc1f
                            nAddressJump = *pnAddress + (MIPS_IMM_S16(nOpcode) * 4);
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x3CA00080;
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80C30000 + OFFSETOF(pCPU, anFCR[31]);
                            } else {
                                iCode += 1;
                            }
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x7CC62839;
                            } else {
                                iCode += 1;
                            }
                            ...
                            *pnAddress -= 4;
                            ...
                            anCode[temp_r23_11] = 0x40820000 | (((iCode - temp_r23_11) & 0x3FFF) << 2);
                            break;
                        case 1: // bc1t
                            nAddressJump = *pnAddress + (MIPS_IMM_S16(nOpcode) * 4);
                            if (anCode != NULL) {
                            ...
                            *pnAddress -= 4;
                            ...
                            anCode[temp_r23_11] = 0x41820000 | (((iCode - temp_r23_11) & 0x3FFF) << 2);
                            break;
                        case 0x02: // bc1fl
                            nAddressJump = *pnAddress + (MIPS_IMM_S16(nOpcode) * 4);
                            if (anCode != NULL) {
                            ...
                            *pnAddress -= 4;
                            ...
                            if (cpuGetPPC(pCPU, pnAddress, pFunction, anCode, &iCode, 0) == 0) {
                                return 0;
                            }
                            if (anCode == NULL) {
                                break;
                    ...
                    switch (MIPS_FMT(nOpcode)) {
                        case 0x14: // w
                            switch (MIPS_FUNCT(nOpcode)) {
                                ...
                                case 0x20: // cvt.s.w
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_W_CVT_SD_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xD0230000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                case 0x21: // cvt.d.w
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xD8230000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]);
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                        ...
                        case 0x10: // s
                            switch (MIPS_FUNCT(nOpcode)) {
                                case 0x00: // add.s
                                    if (cpuCutStoreLoadF(pCPU, nAddress, MIPS_FS(nOpcode))) {
                                        if (anCode != NULL) {
                                            anCode[iCode++] = 0x60000000;
                                        } else {
                                            iCode += 1;
                                        ...
                                        if (anCode != NULL) {
                                            anCode[iCode++] = (0xC0030000 | (MIPS_FS(nOpcode) << 21)) +
                                                              OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                        } else {
                                            iCode += 1;
                                        }
                                    }
                                    if (MIPS_FS(nOpcode) != MIPS_FT(nOpcode)) {
                                        if (cpuCutStoreLoadF(pCPU, nAddress, MIPS_FT(nOpcode))) {
                                            if (anCode != NULL) {
                                                anCode[iCode++] = 0x60000000;
                                            } else {
                                                iCode += 1;
                                            ...
                                            if (anCode != NULL) {
                                                anCode[iCode++] = (0xC0030000 | (MIPS_FT(nOpcode) << 21)) +
                                                                  OFFSETOF(pCPU, aFPR[MIPS_FT(nOpcode)]) + 4;
                                            } else {
                                                iCode += 1;
                                            }
                                        }
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xEC000000 | (MIPS_FD(nOpcode) << 21) |
                                                          (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11) | 0x2A;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0xD0030000 | (MIPS_FD(nOpcode) << 21)) +
                                                          ((OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) + 4) & 0xFFFF);
                                    } else {
                                        iCode += 1;
                                    }
                                    pCPU->nOptimize.destFPR_check = 2;
                                ...
                                case 0x01: // sub.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xEC000000 | (MIPS_FD(nOpcode) << 21) |
                                                          (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11) | 0x28;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x02: // mul.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xEC000000 | (MIPS_FD(nOpcode) << 21) |
                                                          (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11) | 0x32;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x03: // div.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xEC000000 | (MIPS_FD(nOpcode) << 21) |
                                                          (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11) | 0x24;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x04: // sqrt.s
                                    if (cpuCutStoreLoadF(pCPU, nAddress, MIPS_FS(nOpcode))) {
                                        if (anCode != NULL) {
                                            anCode[iCode++] = 0xFC200000 | (MIPS_FS(nOpcode) << 11) | 0x90;
                                        } else {
                                            iCode += 1;
                                        }
                                    } else {
                                        if (anCode != NULL) {
                                            anCode[iCode++] = 0xC0230000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                        } else {
                                            iCode += 1;
                                        }
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_S_SQRT_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xD023000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                case 0x05: // abs.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0xFC000000 | (MIPS_FD(nOpcode) << 21) | (MIPS_FS(nOpcode) << 11) | 0x210;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0xD0030000 | (MIPS_FD(nOpcode) << 21)) +
                                                          OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    pCPU->nOptimize.destFPR_check = 2;
                                ...
                                case 0x07: // neg.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0xFC000000 | (MIPS_FD(nOpcode) << 21) | (MIPS_FS(nOpcode) << 11) | 0x50;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x0C: // round.w.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x38A00000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_ROUND_W_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                case 0x0D: // trunc.w.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_TRUNC_W_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                case 0x0E: // ceil.w.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_CEIL_W_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                case 0x0F: // floor.w.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_FLOOR_W_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                ...
                                case 0x24: // cvt.w.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x38A00000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]);
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x30: // c.f.s
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, anFCR[31]);
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x54A5024E;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, anFCR[31]);
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                ...
                                case 0x32: // c.eq.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0xFC000000 | (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11);
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x4082000C;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x64A50080;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x34: // c.olt.s
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0xFC000000 | (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11) | 0x40;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                            ...
                            switch (MIPS_FUNCT(nOpcode)) {
                                case 0x00: // add.d
                                    if (cpuCutStoreLoadF(pCPU, nAddress, MIPS_FS(nOpcode))) {
                                        ...
                                        if (anCode != NULL) {
                                            anCode[iCode++] = (0xC8030000 | (MIPS_FS(nOpcode) << 21)) +
                                                              OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]);
                                        } else {
                                            iCode += 1;
                                        }
                                    }
                                    if (MIPS_FS(nOpcode) != MIPS_FT(nOpcode)) {
                                        if (cpuCutStoreLoadF(pCPU, nAddress, MIPS_FT(nOpcode))) {
                                            ...
                                            if (anCode != NULL) {
                                                anCode[iCode++] = (0xC8030000 | (MIPS_FT(nOpcode) << 21)) +
                                                                  OFFSETOF(pCPU, aFPR[MIPS_FT(nOpcode)]);
                                            } else {
                                                iCode += 1;
                                            }
                                        }
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xFC000000 | (MIPS_FD(nOpcode) << 21) |
                                                          (MIPS_FS(nOpcode) << 16) | (MIPS_FT(nOpcode) << 11) | 0x2A;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0xD8030000 | (MIPS_FD(nOpcode) << 21)) +
                                                          (OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) & 0xFFFF);
                                    } else {
                                        iCode += 1;
                                    }
                                    pCPU->nOptimize.destFPR_check = 2;
                                ...
                                case 0x04: // sqrt.d
                                    if (cpuCutStoreLoadF(pCPU, nAddress, MIPS_FS(nOpcode))) {
                                        ...
                                        if (anCode != NULL) {
                                            anCode[iCode++] = 0xC8230000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]);
                                        } else {
                                            iCode += 1;
                                        }
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_D_SQRT_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xD823000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]);
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
                                case 0x05: // abs.d
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = (0xD8030000 | (MIPS_FD(nOpcode) << 21)) +
                                                          OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]);
                                    } else {
                                        iCode += 1;
                                    }
                                    pCPU->nOptimize.destFPR_check = 2;
                                ...
                                case 0x06: // mov.d
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xC823000 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]);
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                        ...
                        case 0x15: // l
                            switch (MIPS_FUNCT(nOpcode)) {
                                ...
                                case 0x20: // cvt.s.l
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0x80C30004 + OFFSETOF(pCPU, aFPR[MIPS_FS(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] =
                                            0x48000000 |
                                            ((cpuCompile_L_CVT_SD_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xFC200818;
                                    } else {
                                        iCode += 1;
                                    }
                                    if (anCode != NULL) {
                                ...
                                case 0x21: // cvt.d.l
                                    ...
                                    if (anCode != NULL) {
                                        anCode[iCode++] = 0xD8230000 + OFFSETOF(pCPU, aFPR[MIPS_FD(nOpcode)]) + 4;
                                    } else {
                                        iCode += 1;
                                    }
                                    break;
            ...
            case 0x18: // daddi
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = 0x39000000;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x7CE70734;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x2C070000;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x4080000C;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x3900FFFF;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x7D080734;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x7CA53814;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x7CC64114;
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x90A30004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                    anCode[iCode++] = 0x90C30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                } else {
                    iCode += 1;
                }
                if (anCode != NULL) {
                ...
                if (anCode != NULL) {
                    anCode[iCode++] = (iRegisterB << 16) | 0x7CA00000 | 0x2B78;
                } else {
                    iCode += 1;
                }
                break;
            ...
            case 0x20: // lb
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if (!cpuCutStoreLoadAddr(pCPU, nAddress, MIPS_RS(nOpcode), MIPS_RT(nOpcode), anCode)) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CE00000 | (iRegisterB << 16) | 0x4214;
                        } else {
                            iCode += 1;
                        }
                    } else {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x88070000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x7C000000 | (iRegisterA << 21) | (iRegisterA << 16) | 0x774;
                    } else {
                        iCode += 1;
                    }
                    if (ganMapGPR[MIPS_RT(nOpcode)] & 0x100) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x48000000 | (((u32)pCPU->pfRam - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38A00000 | (iRegisterB << 16) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x54A6843E;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x7CC648AE;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x2C060080;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x41800010;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] =
                            0x48000000 | ((cpuCompile_LB_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if ((iRegisterA = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]) + 4;
                        } else {
                            iCode += 1;
                        }
                    } else {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7CA00000 | (iRegisterA << 16) | 0x7CA00000 | 0x2B78;
                        } else {
                            iCode += 1;
                        }
                    }
            ...
            case 0x21: // lh
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0xA0070000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x7C000000 | (iRegisterA << 21) | (iRegisterA << 16) | 0x734;
                    } else {
                        iCode += 1;
                    }
                    if (ganMapGPR[MIPS_RT(nOpcode)] & 0x100) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] =
                            0x48000000 | ((cpuCompile_LH_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if ((iRegisterA = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
            ...
            case 0x22: // lwl
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x9421FFE8;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x91210008;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x91410010;
                    } else {
                        iCode += 1;
                    }
                    if ((iRegisterA = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)]) + 4;
                        } else {
                            iCode += 1;
                        }
                    } else {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x7CE54214;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38E70000 | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x81230004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                    } else {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7C090000 | (iRegisterB << 21) | (iRegisterB << 11) | 0x378;
                        } else {
                            iCode += 1;
                        }
                    }
                    ...
                    if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x91230004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                        } else {
                            iCode += 1;
                        }
                    } else {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7D200000 | (iRegisterB << 16) | 0x4B78;
                        } else {
                            iCode += 1;
                        }
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x81210008;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x81410010;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38210018;
                    } else {
                        iCode += 1;
                    }
                }
            ...
            case 0x23: // lw
                ...
                switch (gpSystem->eTypeROM) {
                    case SRT_ZELDA2:
                        if (nOpcode == 0x8FBF0014 && nOpcodePrev == 0 && nOpcodeNext == 0x27BD0018) {
                            if (nAddress == 0x8018570C || nAddress == 0x8018628C || nAddress == 0x8016FB5C ||
                                nAddress == 0x8018624C || nAddress == 0x801C0F14 || nAddress == 0x801A9DF4 ||
                                nAddress == 0x801A9D94) {
                                pCPU->nFlagCODE |= 2;
                            }
                        } else if (nOpcode == 0x8FBF0014 && nOpcodePrev == 0x24E40014 && nOpcodeNext == 0x27BD0018U) {
                            pCPU->nFlagCODE |= 2;
                        } else if (nOpcode == 0x8FBF0014 && nOpcodePrev == 0x00603025U && nOpcodeNext == 0x27BD0000) {
                            pCPU->nFlagCODE |= 2;
                        } else if (nOpcode == 0x8FBF001C && nOpcodePrev == 0x248419C4 && nOpcodeNext == 0x8FB00018) {
                            pCPU->nFlagCODE |= 2;
                        }
                        break;
                    case SRT_MARIOPARTY1:
                        if (nOpcode == 0x8C9F0004 && nOpcodePrev == 0x8C9D0000 && nOpcodeNext == 0x8C900000) {
                            pCPU->nFlagCODE |= 2;
                        }
                        break;
                    case SRT_STARFOX:
                        if (nOpcode == 0x8FBF003C && nOpcodePrev == 0 && nOpcodeNext == 0xAFB20000) {
                            pCPU->nFlagCODE |= 2;
                        }
                        break;
                }
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80070000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (ganMapGPR[MIPS_RT(nOpcode)] & 0x100) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] =
                            0x48000000 | ((cpuCompile_LW_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if ((iRegisterA = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
            ...
            case 0x28: // sb
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if (cpuCutStoreLoadAddr(pCPU, nAddress, MIPS_RS(nOpcode), -1, anCode)) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x60000000;
                        } else {
                            iCode += 1;
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x98070000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                } else if (pCPU->nCompileFlag & 0x10) {
                    ...
                    if ((iRegisterA = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7C080000 | (iRegisterA << 21) | (iRegisterA << 11) | 0x378;
                        } else {
                            iCode += 1;
                        }
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] =
                            0x48000000 | ((cpuCompile_SB_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
            ...
            case 0x2A: // swl
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if ((iRegisterB = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x7C050000 | (iRegisterB << 21) | (iRegisterB << 11) | 0x378;
                        } else {
                            iCode += 1;
                        }
                    }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38C00018;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80A30004 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x7CA53430;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x98A70000;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38C6FFF8;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x54E507BF;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38E70001;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x4082FFE8;
                    } else {
                        iCode += 1;
                    }
                }
            ...
            case 0x2B: // sw
                ...
                if (gpSystem->eTypeROM == SRT_MARIOPARTY1) {
                    if (nOpcode == 0xAC9F0004 && nOpcodePrev == 0xAC9D0000 && nOpcodeNext == 0xAC900008) {
                        ...
                        if (ganMapGPR[31] & 0x100) {
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aGPR[31]);
                            } else {
                                iCode += 1;
                            }
                        } else {
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x7CA00000 | (ganMapGPR[31] << 16) | 0x2B78;
                            } else {
                                iCode += 1;
                            }
                        }
                ...
                } else if (gpSystem->eTypeROM == SRT_STARFOX && nOpcode == 0xAFBF003C && nOpcodePrev == 0x007FA025 &&
                           nOpcodeNext == 0xAFB00000) {
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, nReturnAddrLast);
                    } else {
                        iCode += 1;
                ...
                if (nOpcode == 0xACBF0011) {
                    if (var_r17 != 0) {
                        ...
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90C30000 + OFFSETOF(pCPU, nReturnAddrLast);
                        } else {
                            iCode += 1;
                        }
                    }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = (((u32)pCPU->pfStep - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if (var_r17 != 0) {
                    ...
                    if ((iRegisterB = ganMapGPR[MIPS_RS(nOpcode)]) & 0x100) {
                        ...
                        if (cpuCutStoreLoad(pCPU, nAddress, MIPS_RS(nOpcode))) {
                            ...
                            if (anCode != NULL) {
                                anCode[iCode++] = 0x80E30000 + (OFFSETOF(pCPU, aGPR[MIPS_RS(nOpcode)].s32) & 0xFFFF);
                            } else {
                                iCode += 1;
                            }
                        }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90070000 | (iRegisterA << 21) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                } else if (pCPU->nCompileFlag & 0x10) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38A00000 | (iRegisterA << 16) | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                    ...
                    if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                        ...
                        anCode[iCode++] = 0x7C080000 | (iRegisterB << 21) | (iRegisterB << 11) | 0x378;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] =
                            0x48000000 | ((cpuCompile_SW_function - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
            ...
            case 0x31: // lwc1
                if (pCPU->nCompileFlag & 0x10) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x48000000 | (((u32)pCPU->pfRamF - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
                    } else {
                        iCode += 1;
                    }
                    if (pCPU->nCompileFlag & 0x100) {
                    ...
                    if (MIPS_RT(nOpcode) % 2 == 1) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode) - 1]);
                        } else {
                            iCode += 1;
                        }
                    } else {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]) + 4;
                        } else {
                            iCode += 1;
                        }
                    }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x7C072840;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x41810014;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x3CE00000 | ((nSize >> 16) - 1) | 0x8000;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x60E7FFFF;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x38A00000 | MIPS_RT(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x70A50001;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x41820010;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80A70000 | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
            ...
            case 0x35: // ldc1
                if (pCPU->nCompileFlag & 0x10) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90A30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90C30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]) + 4;
                    } else {
                        iCode += 1;
                    }
                    if (var_r17 != 0) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80A70000 | MIPS_RT(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80A70000 | (MIPS_RT(nOpcode) + 4);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
            ...
            case 0x37: // ld
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80070000 | (iRegisterA << 21) | (MIPS_IMM_U16(nOpcode) + 4);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
            ...
            case 0x39: // swc1
                if (pCPU->nCompileFlag & 0x10) {
                    ...
                    if (MIPS_RT(nOpcode) % 2 == 1) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode) - 1]);
                        } else {
                            iCode += 1;
                        }
                    } else {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]) + 4;
                        } else {
                            iCode += 1;
                        }
                    }
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90A70000 | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                }
            ...
            case 0x3D: // sdc1
                if (pCPU->nCompileFlag & 0x10) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x81030000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x82130000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]) + 4;
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80A30000 + OFFSETOF(pCPU, aFPR[MIPS_RT(nOpcode)]);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90A70000 | (MIPS_IMM_U16(nOpcode) + 4);
                    } else {
                        iCode += 1;
                    }
                }
            ...
            case 0x3F: // sd
                ...
                if (pCPU->nFlagRAM & (1 << MIPS_RS(nOpcode))) {
                    ...
                    if (var_r6_33 != 0 && !cpuCutStoreLoadAddr(pCPU, nAddress, MIPS_RS(nOpcode), -1, anCode)) {
                        if (anCode != NULL) {
                            anCode[iCode++] = 0x60000000;
                        } else {
                            iCode += 1;
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x80C30000 + OFFSETOF(pCPU, aGPR[MIPS_RT(nOpcode)]);
                    } else {
                        iCode += 1;
                    }
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90C70000 | MIPS_IMM_U16(nOpcode);
                    } else {
                        iCode += 1;
                    }
                    if ((iRegisterB = ganMapGPR[MIPS_RT(nOpcode)]) & 0x100) {
                    ...
                    if (anCode != NULL) {
                        anCode[iCode++] = 0x90070000 | (iRegisterB << 21) | (MIPS_IMM_U16(nOpcode) + 4);
                    } else {
                        iCode += 1;
                    }
                } else if (pCPU->nCompileFlag & 0x10) {
    ...
    if (iCode == *piCode) {
        if (anCode != NULL) {
            ...
            anCode[iCode++] = 0x3CA00000 | (nAddress >> 16);
            anCode[iCode++] = 0x60A50000 | (nAddress & 0xFFFF);
            anCode[iCode++] = 0x48000000 | (((u32)pCPU->pfStep - (u32)&anCode[iCode]) & 0x03FFFFFC) | 1;
        } else {
            if (var_r17 != 0) {
                var_r3_4 = 5;
    ...
    *piCode = iCode;
    ...
    if (var_r17 != 0 || pCPU->nOptimize.addr_check == 0) {
        pCPU->nOptimize.addr_last = -1;
    }
    return 1;
}
